...
import { WatchShell } from '@/components/watch-chrome'
...
export function EnrollmentPage({ onEnrolled }: EnrollmentPageProps) {
  ...
  return (
    <WatchShell className="items-center justify-center p-6">
        ...
        <Card className="rounded-[22px] border-white/8 bg-card/75 backdrop-blur-xl">
          <CardHeader className="items-center text-center">
            ...
            <CardDescription className="font-display">
              Gere o código em <span className="text-foreground">xvpn.ihuull.com → Dispositivos</span> e cole abaixo.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  placeholder="Código gerado em Dispositivos no painel"
                  autoComplete="off"
                  required
                />
              </div>
