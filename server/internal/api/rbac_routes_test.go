...
var rbacRouteCases = []rbacRouteCase{
	...
	{"list-project-packages", http.MethodGet, "/api/projects/missing/packages", nil, "any"},
	{"upload-project-package", http.MethodPost, "/api/projects/missing/packages", nil, "any"},
	{"download-project-package", http.MethodGet, "/api/projects/missing/packages/1/download", nil, "any"},
	{"npm-packument", http.MethodGet, "/api/packages/missing/npm/foo", nil, "any"},
	{"npm-publish", http.MethodPut, "/api/packages/missing/npm/foo", nil, "any"},
	{"pypi-upload", http.MethodPost, "/api/packages/missing/pypi", nil, "any"},
	{"pypi-simple", http.MethodGet, "/api/packages/missing/pypi/simple/", nil, "any"},
	{"pypi-simple-pkg", http.MethodGet, "/api/packages/missing/pypi/simple/foo", nil, "any"},
