...
var rbacRouteCases = []rbacRouteCase{
	...
	{"list-networks", http.MethodGet, "/api/networks", nil, "viewerUp"},
	...
	{"create-network", http.MethodPost, "/api/networks", createNetworkRequest{Slug: "rbac-lab"}, "adminOnly"},
	...
	{"get-project", http.MethodGet, "/api/projects/xcorp/missing", nil, "any"},
	{"create-project", http.MethodPost, "/api/projects", createProjectRequest{Org: "xcorp", Slug: "rbac-proj", Name: "RBAC"}, "adminOnly"},
	...
	{"list-xgit-packages", http.MethodGet, "/api/xgit/packages", nil, "any"},
	{"list-project-packages", http.MethodGet, "/api/projects/xcorp/missing/packages", nil, "any"},
	{"upload-project-package", http.MethodPost, "/api/projects/xcorp/missing/packages", nil, "any"},
	{"download-project-package", http.MethodGet, "/api/projects/xcorp/missing/packages/1/download", nil, "any"},
	{"npm-packument", http.MethodGet, "/api/packages/xcorp/missing/npm/foo", nil, "any"},
	{"npm-publish", http.MethodPut, "/api/packages/xcorp/missing/npm/foo", nil, "any"},
	{"pypi-upload", http.MethodPost, "/api/packages/xcorp/missing/pypi", nil, "any"},
	{"pypi-simple", http.MethodGet, "/api/packages/xcorp/missing/pypi/simple/", nil, "any"},
	{"pypi-simple-pkg", http.MethodGet, "/api/packages/xcorp/missing/pypi/simple/foo", nil, "any"},
	{"toggle-project-star", http.MethodPost, "/api/projects/xcorp/missing/star", nil, "any"},
	{"patch-xgit-settings", http.MethodPatch, "/api/xgit/settings", updateForgeSettingsRequest{}, "adminOnly"},
	{"list-project-tree", http.MethodGet, "/api/projects/xcorp/missing/tree", nil, "any"},
	{"get-project-blob", http.MethodGet, "/api/projects/xcorp/missing/blob?path=README", nil, "any"},
	{"list-project-commits", http.MethodGet, "/api/projects/xcorp/missing/commits", nil, "any"},
	{"update-project", http.MethodPatch, "/api/projects/xcorp/missing", updateProjectRequest{}, "adminOnly"},
	{"set-project-members", http.MethodPut, "/api/projects/xcorp/missing/members", setProjectMembersRequest{Members: []projectMemberIn{{UserID: 1, Role: store.ProjectRoleOwner}}}, "adminOnly"},
	{"get-project-git", http.MethodGet, "/api/projects/xcorp/missing/git", nil, "any"},
	{"get-project-codespace-envs", http.MethodGet, "/api/projects/xcorp/missing/codespaces/envs", nil, "any"},
	{"put-project-codespace-envs", http.MethodPut, "/api/projects/xcorp/missing/codespaces/envs", putProjectEnvsRequest{}, "any"},
	{"init-project-git", http.MethodPost, "/api/projects/xcorp/missing/git", nil, "adminOnly"},
	{"set-protected-branches", http.MethodPut, "/api/projects/xcorp/missing/protected-branches", setProtectedBranchesRequest{Branches: []protectedBranchJSON{{Pattern: "main", MinPushRole: store.ProjectRoleMaintainer}}}, "adminOnly"},
	{"list-project-branches", http.MethodGet, "/api/projects/xcorp/missing/branches", nil, "any"},
	{"list-codespaces", http.MethodGet, "/api/xcodespaces", nil, "any"},
	{"create-codespace", http.MethodPost, "/api/xcodespaces", createCodespaceRequest{Org: "xcorp", Slug: "lab"}, "any"},
	{"get-codespace", http.MethodGet, "/api/xcodespaces/x", nil, "any"},
	{"start-codespace", http.MethodPost, "/api/xcodespaces/x/start", nil, "any"},
	{"patch-codespace-demo", http.MethodPatch, "/api/xcodespaces/x/demo", patchCodespaceDemoRequest{Name: "app"}, "any"},
	...
	{"list-issues", http.MethodGet, "/api/projects/xcorp/missing/issues", nil, "any"},
	{"create-issue", http.MethodPost, "/api/projects/xcorp/missing/issues", createIssueRequest{Title: "t"}, "any"},
	{"get-issue", http.MethodGet, "/api/projects/xcorp/missing/issues/1", nil, "any"},
	{"patch-issue", http.MethodPatch, "/api/projects/xcorp/missing/issues/1", patchIssueRequest{}, "any"},
	{"list-labels", http.MethodGet, "/api/projects/xcorp/missing/labels", nil, "any"},
	{"list-milestones", http.MethodGet, "/api/projects/xcorp/missing/milestones", nil, "any"},
	{"create-milestone", http.MethodPost, "/api/projects/xcorp/missing/milestones", createMilestoneRequest{Title: "v1"}, "any"},
	{"patch-milestone", http.MethodPatch, "/api/projects/xcorp/missing/milestones/1", patchMilestoneRequest{}, "any"},
	{"list-work-projects", http.MethodGet, "/api/projects/xcorp/missing/work-projects", nil, "any"},
	{"create-work-project", http.MethodPost, "/api/projects/xcorp/missing/work-projects", createWorkProjectRequest{Title: "board"}, "any"},
	{"get-work-project", http.MethodGet, "/api/projects/xcorp/missing/work-projects/1", nil, "any"},
	{"patch-work-project", http.MethodPatch, "/api/projects/xcorp/missing/work-projects/1", patchWorkProjectRequest{}, "any"},
	{"list-work-items", http.MethodGet, "/api/projects/xcorp/missing/work-projects/1/items", nil, "any"},
	{"create-work-item", http.MethodPost, "/api/projects/xcorp/missing/work-projects/1/items", createWorkItemRequest{Title: "card"}, "any"},
	{"patch-work-item", http.MethodPatch, "/api/projects/xcorp/missing/work-projects/1/items/1", patchWorkItemRequest{}, "any"},
	{"delete-work-item", http.MethodDelete, "/api/projects/xcorp/missing/work-projects/1/items/1", nil, "any"},
	{"list-merge-requests", http.MethodGet, "/api/projects/xcorp/missing/merge-requests", nil, "any"},
	{"create-merge-request", http.MethodPost, "/api/projects/xcorp/missing/merge-requests", createMRRequest{Title: "t", SourceBranch: "feat", TargetBranch: "main"}, "any"},
	{"get-merge-request", http.MethodGet, "/api/projects/xcorp/missing/merge-requests/1", nil, "any"},
	{"patch-merge-request", http.MethodPatch, "/api/projects/xcorp/missing/merge-requests/1", nil, "any"},
	{"merge-merge-request", http.MethodPost, "/api/projects/xcorp/missing/merge-requests/1/merge", nil, "any"},
	{"close-merge-request", http.MethodPost, "/api/projects/xcorp/missing/merge-requests/1/close", nil, "any"},
	{"list-mr-commits", http.MethodGet, "/api/projects/xcorp/missing/merge-requests/1/commits", nil, "any"},
	{"get-mr-diff", http.MethodGet, "/api/projects/xcorp/missing/merge-requests/1/diff", nil, "any"},
	{"list-mr-reviews", http.MethodGet, "/api/projects/xcorp/missing/merge-requests/1/reviews", nil, "any"},
	{"create-mr-review", http.MethodPost, "/api/projects/xcorp/missing/merge-requests/1/reviews", nil, "any"},
	{"put-contents", http.MethodPut, "/api/projects/xcorp/missing/contents", putContentsRequest{Path: "README", Content: "x", Message: "m"}, "any"},
	{"list-workflow-templates", http.MethodGet, "/api/ci/workflow-templates", nil, "any"},
	{"apply-workflow-template", http.MethodPost, "/api/projects/xcorp/missing/workflows", applyWorkflowRequest{TemplateID: "go"}, "any"},
	{"get-archive", http.MethodGet, "/api/projects/xcorp/missing/archive", nil, "any"},
	{"list-ci-jobs", http.MethodGet, "/api/projects/xcorp/missing/jobs", nil, "any"},
	{"get-ci-job", http.MethodGet, "/api/projects/xcorp/missing/jobs/1", nil, "any"},
	{"get-ci-job-log", http.MethodGet, "/api/projects/xcorp/missing/jobs/1/log", nil, "any"},
	{"cancel-ci-job", http.MethodPost, "/api/projects/xcorp/missing/jobs/1/cancel", nil, "any"},
	{"approve-ci-job", http.MethodPost, "/api/projects/xcorp/missing/jobs/1/approve", nil, "any"},
	{"rerun-ci-job", http.MethodPost, "/api/projects/xcorp/missing/jobs/1/rerun", nil, "any"},
	{"list-project-runners", http.MethodGet, "/api/projects/xcorp/missing/runners", nil, "any"},
	...
	{"get-backup-settings", http.MethodGet, "/api/backups/settings", nil, "viewerUp"},
	{"list-backup-destinations", http.MethodGet, "/api/backups/destinations", nil, "viewerUp"},
	{"list-backup-jobs", http.MethodGet, "/api/backups/jobs", nil, "viewerUp"},
	{"patch-backup-settings", http.MethodPatch, "/api/backups/settings", patchBackupSettingsRequest{}, "adminOnly"},
	{"create-backup-dest", http.MethodPost, "/api/backups/destinations", upsertBackupDestRequest{Name: "nas", Kind: store.BackupKindSFTP}, "adminOnly"},
	{"patch-backup-dest", http.MethodPatch, "/api/backups/destinations/1", upsertBackupDestRequest{Name: "nas"}, "adminOnly"},
	{"delete-backup-dest", http.MethodDelete, "/api/backups/destinations/1", nil, "adminOnly"},
	{"run-backup", http.MethodPost, "/api/backups/destinations/1/run", runBackupRequest{DryRun: true}, "adminOnly"},
	...
	{"list-project-services", http.MethodGet, "/api/projects/xcorp/missing/services", nil, "any"},
