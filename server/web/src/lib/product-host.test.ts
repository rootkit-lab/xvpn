...
describe('productKind', () => {
  it('reconhece cada host de produto — corp não cai no painel', () => {
    ...
    expect(productKind('xmonitor.corp.ihuull.com')).toBe('xmonitor-corp')
    expect(productKind('xmonitor.corp.localhost')).toBe('xmonitor-corp')
  ...
  it('trata apps de produto com login /login (não /admin)', () => {
    ...
    expect(isProductAppHost('xmonitor.corp.ihuull.com')).toBe(true)
...
describe('headerProduct', () => {
  it('mapeia host e path para a identidade do chrome', () => {
    ...
    expect(headerProduct('xmonitor.corp.ihuull.com', '/')).toBe('xmonitor')
...
describe('loginAudience', () => {
  it('emite aud do host de produto', () => {
    ...
    expect(loginAudience('xmonitor.corp.ihuull.com')).toBe('xmonitor')
